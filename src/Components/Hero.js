            ...
            <div class="d-flex flex-column w-75 mx-auto py-5 text-center">
                ...
                <div >
                    <svg version="1.1" id="Layer_1"x="0px" y="0px" width="20%" height = "20%"
                        ...
                        <path className="st0" d="M274.17,357.83c-2.67,18.52-10.64,46.18-34.28,59.41c-4.76,2.66-11.03,5.23-19.04,6.51H56.88
                        ...
                        {/* <path className="st0" d="M247.11,345.84c-2.14,14.82-8.51,36.94-27.42,47.53c-3.81,2.13-8.82,4.18-15.23,5.21H73.28
                        ...
                        <path className="st1" d="M247.11,356.23c-2.14,13.05-8.51,32.54-27.42,41.86c-3.81,1.87-8.82,3.69-15.23,4.59H73.28
                        ...
                        <path className="st0" d="M358.73,274.63c0,45.96-37.26,83.22-83.22,83.22c-0.45,0-0.89,0-1.34-0.02c1.35-9.29,1.36-16.28,1.34-17.99
