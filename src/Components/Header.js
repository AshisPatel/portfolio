            ...
            { width > 767 ?
                <nav className="mt-2">
                    <ul className="d-flex px-auto justify-content-between">
                        <Link to="/" className="nav-link"><FontAwesomeIcon icon="grin-beam" /> About Me</Link>
                        <Link to="/projects" className="nav-link"><FontAwesomeIcon icon="code-branch" /> Projects</Link>
                        <Link to="/contact" className="nav-link"><FontAwesomeIcon icon="address-card" /> Contact</Link>
